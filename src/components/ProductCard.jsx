            ...
            <>
                {
                    productArr.map((item, index)=>(
                        <div key={index} className="product_card">                                                                           
                            <Link to={`/collection/${series}/${product}/${dictionary.Range[item.id]}`} className={loadedImg.includes(index + item.id) ? 'show-img':'hide'}>
                                <img 
            ...
            <>
                {
                    productArr.map((item, index)=>(
                        <div className="product_card" key={index + item.id}>                            
                            <Link to={`/collection/${series}/${product}/single/${item.product_code}`} className={loadedImg.includes(index + item.id) ? 'show-img':'hide'}>
                                <img 
